...
public class SalesReport
{
   ...
   public static String getFileName()
   {
      ...
      file = JOptionPane.showInputDialog("Enter the name of the " +
   ...
   // The getTotalSales method opens a file and reads the daily 
   // sales amounts, accumulating the total. The total is returned.
