// This program demonstrates how you cannot use the == operator to compare 
// two objects and determine whether they contain the same values.
...
public class BadStockCompare
{
   public static void main(String[] args)
   {
      ...
      // Use the == operator to compare the objects (THIS IS A MISTAKE)
