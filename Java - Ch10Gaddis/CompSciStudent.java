...
public class CompSciStudent extends Student
{
   ...
   // This method sets the number of math hours taken.
   public void setMathHours(int math)
   {
      mathHours = math;
   }

   // This method sets the number of computer science hours taken.
   public void setCsHours(int cs)
   {
      csHours = cs;
   }

   // This method sets the number of general ed hours taken.
   public void setGenEdHours(int genEd)
   {
      genEdHours = genEd;
   }

   // This method returns the the number of hours remaining to be taken.
