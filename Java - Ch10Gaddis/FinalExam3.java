...
public class FinalExam3 extends GradedActivity implements Relatable
{
   ...
   // The constructor sets the number of questions on the exam and 
   ...
   // This method compares the calling object to the argument object for equality,
	// and returns true if the calling object's score is equal to the argument's score.
   ...
   // This method determines whether the calling object is greater than the argument
   // object, and returns true if the calling object's score is greater than the 
   ...
   // This method determines whether the calling object is less than the argument 
	// object, and returns true if the calling object's score is less than the 
	// argument object's score.
