...
public class Polymorphic
{
   public static void main(String[] args)
   {
      ...
      // The second test is a pass/fail test; the student missed 5 out 
		// of 20 questions, and the minimum passing grade is 60
      tests[1] = new PassFailExam(20, 5, 60);

      // The third test is the final exam; there were 50 questions and 
		// the student missed 7
