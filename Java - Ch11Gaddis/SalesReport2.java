...
public class SalesReport2
{
   public static void main(String[] args)
   {
      ...
      // If the openFile method returns null, the file was not found; get a new file name
   ...
   // This method opens the specified file and returns a reference to a Scanner object.
