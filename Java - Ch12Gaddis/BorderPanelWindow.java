// This class demonstrates how JPanels can be nested inside each 
// region of a content pane governed by a BorderLayout manager.
...
public class BorderPanelWindow extends JFrame
{
   ...
   public BorderPanelWindow()
   {
      ...
      // Add a button to each of the panels
      panel1.add(button1);
      panel2.add(button2);
      panel3.add(button3);
      panel4.add(button4);
   ...
   // The main method creates an instance of the BorderPanelWindow class, 
