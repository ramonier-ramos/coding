...
public class MetricConverterWindow2 extends JFrame
{
...
//*****************************************************************************
			// ADDED TO PREVENT PROGRAM CRASH IF INPUT VALUE OMITTED BY USER
			if (input.equals(""))			  // Check if text field is empty
			{
				kiloTextField.setText("0");  // Display default value in text field
				input = "0";					  // Set input variable to default value
			}
//*****************************************************************************
