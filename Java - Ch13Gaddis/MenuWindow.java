...
public class MenuWindow extends JFrame
{
   ...
   public MenuWindow()
   {
      ...
      messageLabel = new JLabel("Use the Text menu to change my color " + 
   ...
   // This method builds the File menu and returns a reference to 
	// its JMenu object.
   ...
   // This method builds the Text menu and returns a reference to 
	// its JMenu object.
   private void buildTextMenu()
   {
      // Create the radio button menu items used to change the color 
		// of the text, and add an action listener to each one
      ...
      // Create a check box menu item to make the text visible 
		// or invisible
   ...
   // This private inner class handles the event that is generated 
